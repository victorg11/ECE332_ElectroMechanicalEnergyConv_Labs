/************************ dSPACE target specific file *************************
   ...
   Include file .\Lab4_rti1104\Lab4_th.c :

   Task Configuration file for model : Lab4

   RTI1104 7.9 (02-Nov-2017)/2.17
   21-Feb-2020 13:37:35
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [0.0001 0] s      : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Lab4_rti1104\Lab4_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (0.0001 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */
